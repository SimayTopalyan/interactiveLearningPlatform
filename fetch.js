document
  ...
  .addEventListener("submit", function (event) {
    ...
    fetch("https://socialapiiii-a560cc9f939f.herokuapp.com/api/users", {
      method: "POST",
      headers: {
  ...
  async function getUserByEmail(email) {
    try {
      const response = await fetch(`https://socialapiiii-a560cc9f939f.herokuapp.com/api/users/userss/${email}`);
...
document
  ...
  .addEventListener("submit", async function (event) {
    ...
    try {
      const response = await fetch("https://socialapiiii-a560cc9f939f.herokuapp.com/api/users/login", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
